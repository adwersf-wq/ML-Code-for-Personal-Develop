...
plt.title('GBR模型验证图（HHV）', fontsize=22)
...
ax.set_title('GBR模型SHAP特征值分布（HHV）', fontsize=14, fontweight='bold')
...
# file_pairs = [
#     ("new_data_corncob.xlsx", "prediction_results_GBR_corncob_HHV.xlsx"),
#     ("new_data_wheat_shell.xlsx", "prediction_results_GBR_wheat_shell_HHV.xlsx"),
#     ("new_data_walnut_shell.xlsx", "prediction_results_GBR_walnut_shell_HHV.xlsx")
# ]
#
