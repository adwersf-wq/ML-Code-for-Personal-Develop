...
# # 参数网格（根据XGBoost调整）
# param_grid = {
#     'regressor__xgb__n_estimators': [100, 200, 300, 400, 500],
#     'regressor__xgb__max_depth': [3, 6, 9, 12],
...
plt.title('XGBoost模型验证图（产率）', fontsize=22)
...
ax.set_title('XGBoost模型SHAP特征值分布（产率）', fontsize=14, fontweight='bold')
...
# file_pairs = [
#     ("new_data_corncob.xlsx", "prediction_results_XGB_corncob_Yield.xlsx"),
#     ("new_data_wheat_shell.xlsx", "prediction_results_XGB_wheat_shell_Yield.xlsx"),
#     ("new_data_walnut_shell.xlsx", "prediction_results_XGB_walnut_shell_Yield.xlsx")
# ]
#
