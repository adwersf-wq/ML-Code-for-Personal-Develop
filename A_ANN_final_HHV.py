...
feature_pipeline = Pipeline([
    ...
    ('ann', MLPRegressor(
        hidden_layer_sizes=(250,150),  # 替换为最佳 hidden_layer_sizes
        activation='relu',  # 替换为最佳 activation
        solver='adam',  # 替换为最佳 solver
        alpha=0.01,  # 替换为最佳 alpha
        learning_rate_init=0.001,  # 替换为最佳 learning_rate_init
        random_state=42,
        early_stopping=True,
...
plt.title('ANN模型验证图（HHV）', fontsize=22)
...
# file_pairs = [
#     ("new_data_corncob.xlsx", "prediction_results_ANN_corncob_HHV.xlsx"),
#     ("new_data_wheat_shell.xlsx", "prediction_results_ANN_wheat_shell_HHV.xlsx"),
#     ("new_data_walnut_shell.xlsx", "prediction_results_ANN_walnut_shell_HHV.xlsx")
# ]
#
